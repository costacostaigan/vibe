  ...
  return (
    <div className="bg-white">
      <div className="flex flex-row items-center justify-between mb-6">
        ...
        >
          <Message name="modules.account.inputs.shipping.delivery"/>
        ...
        {!isOpen &&
          ...
          cart?.email && (
            <Text>
              ...
              >
                <Message name="modules.account.inputs.billings.edit"/>
              </button>
            </Text>
          )}
      </div>
      {isOpen ? (
        <div data-testid="delivery-options-container">
                ...
                availableShippingMethods.map((option) => {
                  return (
                    <RadioGroup.Option
                      ...
                      className={clx(
                        "flex items-center justify-between text-small-regular cursor-pointer py-4 border px-8 mb-2 hover:outline-yellow-400 hover:outline",
                        {
                          "border-yellow-400":
                            option.id ===
          ...
          >
            <Message name="modules.account.inputs.shipping.to_payment"/>
          </Button>
        </div>
      ) : (
        <div>
            ...
            {cart && cart.shipping_methods.length > 0 && (
              <div className="flex flex-col w-1/3">
                <Text className="txt-medium-plus text-ui-fg-base mb-1">
                  <Message name="modules.order.completed.shipping.method"/>
                </Text>
