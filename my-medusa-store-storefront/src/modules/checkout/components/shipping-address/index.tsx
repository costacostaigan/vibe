  ...
  return (
    <>
      {customer && (addressesInRegion?.length || 0) > 0 && (
        <Container className="mb-6 flex flex-col gap-y-4 p-5 rounded-none !border-yellow-300 border shadow-none">
          <p className="text-small-regular">
            <Message name="modules.account.addresses.use_saved" args={{ name: customer.first_name }}/>
          </p>
