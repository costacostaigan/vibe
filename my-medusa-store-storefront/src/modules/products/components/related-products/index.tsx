...
export default async function RelatedProducts({
  ...
  return (
    <div className="product-page-constraint">
      <div className="mb-12">
        <h2 className="font-light uppercase text-6xl mb-3">
          <Message name="modules.common.product.related_products.title" />
        </h2>
        <p className="max-w-lg">
          <Message name="modules.common.product.related_products.description" />
        </p>
      </div>

      <ul className="grid sm:grid-cols-2 small:grid-cols-3 medium:grid-cols-4 gap-x-6 gap-y-8">
